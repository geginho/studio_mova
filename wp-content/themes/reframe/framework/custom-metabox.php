	...
	function md_cc_field ($args=array()) {
		...
		if($args[0]=='info' || $args[0]=='info-array' || $args[0]=='info-array-post' || $args[0]=='info-array-intro') {
			...
			$res .= '<div style="width:97%; padding:30px 15px 0 15px; float:left">
					<a href="javascript:void(0);" class="nhp-opts-upload-intro button-secondary" data-name="'.$field_name.'" rel-id="new">Add New Image</a>
					<a href="javascript:void(0);" class="add-more-videos-intro button-secondary" data-name="'.$field_name.'" rel-id="new">Add Video</a>
			...
			$res .= '<div style="width:97%; padding:30px 15px 0 15px; float:left">
					<a href="javascript:void(0);" class="nhp-opts-upload button-secondary" data-name="'.$field_name.'" rel-id="new">Add New Image</a>
					<a href="javascript:void(0);" class="add-more-videos button-secondary" data-name="'.$field_name.'" rel-id="new">Add Video</a>
			...
			$res = '<div style="width:97%; padding:30px 15px 0 15px; float:left">
					...
					<a href="javascript:void(0);" class="nhp-opts-upload button-secondary" data-name="'.$field_name.'" rel-id="new">Add New Image</a>
					<a href="javascript:void(0);" class="add-more-videos button-secondary" data-name="'.$field_name.'" rel-id="new">Add Video</a>
					<a href="javascript:void(0);" class="add-more-text button-secondary" data-name="'.$field_name.'" rel-id="new">Add Text</a>
		...
		if($type=='imagearr') {
			...
			if(is_array($media)) {
				foreach($media as $v) {
					...
					$output .= '<br class="clear"><br class="clear"><small><strong>URL</strong> <em style="color:#999">Optional. If present, image will be linked to the following URL.</em></small><br class="clear" >';
					...
					$output .= '<select id="work-media-link-target-'.$s2.'" name="work-media-link-target[]" class="urlselector" style="margin-top:5px;">';
					...
					$output .= '<br class="clear"><br class="clear"><small><strong>Width</strong> - <em style="color:#999">Half width allows to place two consecutive images in same row</em></small><br class="clear" >';
					
					$output .= '<select name="work-media-photoalignment[]" class="urlselector" style="margin-left:0;margin-top:5px; width:140px">';
					
					$output .= '<option value="landscape" '.selected($mediapalign[$s2], 'landscape', false).'>Full width</option>
					<option value="portrait" '.selected($mediapalign[$s2], 'portrait', false).'>Half width</option>';
					
					$output .= '</select>';
					
					$output .= '<br class="clear" ><br class="clear" ><small><strong>Lightbox</strong></small><br class="clear" >';
					
					$output .= '<select id="work-media-fancy-'.$s2.'" name="work-media-fancy[]" class="urlselector" style="margin-left:0; width:140px; margin-top:5px;">';
