...
jQuery(document).ready(function(){
	...
	function addto_Composition(imgurl) { 
			divs++;
			var cnt = (jQuery('#md-sortable-media .imgarr').length+1);
			var ids = 'new-md-field-'+divs;
			var cont = '<div id="d'+ids+'" class="imgarr" style="display:none">\
						...
						<small><strong>Width</strong> - <em style="color:#999">Half width allows to place two consecutive images in same row</em></small><br class="clear" > \
						<select name="work-media-photoalignment[]" class="urlselector" style="margin-left:0;width:140px"> \
						<option value="landscape">Full width</option> \
						<option value="portrait">Half width</option> \
						</select> \
						<br class="clear" ><br class="clear" ><strong>Lightbox</strong><br class="clear" ><select id="work-media-fancy-'+ids+'" name="work-media-fancy[]" class="urlselector" style="margin-left:0;width:140px"> \
