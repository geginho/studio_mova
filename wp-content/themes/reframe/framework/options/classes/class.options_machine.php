	...
	*/
	...
	public static function optionsframework_custompost_function($id,$std,$oldorder,$order,$int){
		...
		$slider .= '<select class="slide of-input" name="'. $id .'['.$order.'][thumbnailcaption]" id="'. $id .'_'.$order .'_slide_title" style="width:320px">
						<option value="inside" '.selected($newval['thumbnailcaption'],'inside',false).'>Overlay</option>
...
display: inline-block;">Font Color</small>';
		...
		$slider .= '<br class="clear"><br><small>BG color will be applied if Thumbnail caption placement set as "Overlay". Also, BG color will be ignored if Transparent Thumbnail Overlay option is turned on.</small>';
