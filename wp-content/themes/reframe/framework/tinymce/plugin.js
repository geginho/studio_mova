(function ()
{
	...
	tinymce.PluginManager.add('colShortcodes', function(editor, url) {
		
			function norpopup(popup) {
				
				tb_show("Northeme Shortcodes", url + "/popup.php?popup=" + popup + "&id="+editor.id+"&width=" + 800);
				
			}
					
			editor.addButton('colShortcodes', {
				type: 'menubutton',
				text: ':N Shortcodes',
				tooltip : '',
				 menu: [
