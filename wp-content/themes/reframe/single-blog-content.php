               	...
               	<div class="blogbox <?php if($md_info_align=='Bottom') echo 'full';?>">
                    ...
                    <div class="infoside <?php if(!$format && $md_info_align!='Bottom') { echo 'forstandard1';}?> singlepage">
                      ...
                      <div class="bottom singlepage">
                            ...
                            <span class="loop-tags" <?php if($md_info_align=='Bottom'){ echo 'style="margin-top:0; margin-bottom:20px;"'; }?>>
                            <?php 
                            ...
                            <div class="sharingbottom"> 
								...
								?>
                                <div class="resdontshow shr" style="display:none"><strong><?php _e('SHARE : ','northeme');?></strong></div>
                                <?php
									echo $sharingbutton;
								 	} 
								?>
