...
$col_shortcodes['icons'] = array(
	'params' => array(
		'name' =>  array(
			...
			'desc' => __('Enter your icon name. E.g. : icon-remove <br>To see complete icon list, <a href="http://northeme.com/fontawesome.png" target="_blank">please click here</a>', 'framework')
		),
			'size' => array(
			'type' => 'select',
			'label' => __('Size', 'framework'),
