...
$of_options[] = array(
				...
				'type' => 'text',
				'name' => __('Logo Width', ''),
				'desc' => __('It allows you to specify maximum width value of your logo by pixel (px). By defaut : 200', ''),
				'std' => '100'
				);
...
$of_options[] = 		array(
						'id' => 'md_social_instagram',
						'type' => 'text',
						'name' => __('Instagram', ''),
						'desc' => __('E.g. http://instagram.com/username', ''),
						'std' => ''
						);	
...
$of_options[] = 		array(
						...
						'type' => 'text',
						'name' => __('Last FM', ''),
						'desc' => __('E.g. http://www.last.fm/user/username', ''),
						'std' => ''
						);							
...
$of_options[] = 		array(
						...
						'type' => 'text',
						'name' => __('Behance', ''),
						'desc' => __('E.g. http://behance.net/', ''),
						'std' => ''
						);							
							
						
$of_options[] = 		array(
						'id' => 'md_social_soundcloud',
						'type' => 'text',
						'name' => __('SoundCloud', ''),
						'desc' => __('E.g. http://soundcloud.com/', ''),
						'std' => ''
						);							
							
													
$of_options[] = 		array(
						'id' => 'md_social_blogger',
						'type' => 'text',
						'name' => __('Amazon', ''),
						'desc' => __('E.g. http://blogger.com/', ''),
						'std' => ''
						);							
