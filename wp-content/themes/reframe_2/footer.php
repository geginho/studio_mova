            ...
            <?php if(!$md_home_full) { ?>
        	 ...
        	 <div class="<?php echo $fclass?> columns">	
                ...
                <div class="<?php echo $fclass?>  alpha columns border-color footertext">
					...
					<?php _e('<div class="credits"><a href="http://northeme.com/themes/reframe" target="_blank">Reframe</a> by <a href="http://northeme.com" target="_blank">Northeme</a>. <span class="wp">Powered by <a href="http://wordpress.org" target="_blank">WordPress</a></span></div>','northeme')?>
                    </div>
